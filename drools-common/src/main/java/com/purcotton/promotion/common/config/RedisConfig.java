package com.purcotton.promotion.common.config;
...
public class RedisConfig {
   ...
   /* @Bean(name = "byteRedisTemplate")
    public RedisTemplate<String, Object> byteRedisTemplate() {
        RedisTemplate<String,Object> template = new RedisTemplate<>();
        JdkSerializationRedisSerializer redisSerializer = new JdkSerializationRedisSerializer();
        RedisSerializer<String> stringRedisSerializer = new StringRedisSerializer();

        template.setConnectionFactory(template.getConnectionFactory());//jedisConnectionFactory()
